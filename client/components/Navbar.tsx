...
const Navbar = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-2 bg-black fixed top-0 left-0 w-full z-50 ">
      <Image
        src={logo}
        width={150}
        height={150}
      ...
      />
      <div className="w-full flex justify-center items-center  text-white border-t border-b border-slate-500">
        <div
